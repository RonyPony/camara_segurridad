...
{
    public partial class Cap_empleados : Form
    {
...
"persist security info=False;initial catalog=GossipCam");
        ...
        public void enviar()
        {
            try
            {
                ...
                string nombramiento = maskedTextBox4.Text;
                string dep = textBox5.Text;
                string cargo = textBox6.Text;
                string sueldo = textBox7.Text;
                string correo = textBox4.Text;

                string consulta = "insert into empleados (nombre,apellidos,direccion,telefono,cedula,sexo,celular,nombramiento,departamento,cargo,sueldo,correo)values('" + nombre + "','" + apellidos + "','" + direccion + "','" + telefono + "','"+ cedula +"','" + sexo + "','" + celular + "','" + nombramiento + "','" + dep + "','" + cargo + "','" + sueldo + "','" + correo + "')";
