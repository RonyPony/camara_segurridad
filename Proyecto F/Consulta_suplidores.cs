...
{
    public partial class Consulta_suplidores : Form
    {
...
"persist security info=False;initial catalog=GossipCam");
        ...
        public void cargar()
        {
            ...
            {
                conexion.Open();
                string comando = "select codigoSuplidor,nombre,direccion,correo,telefono from suplidores";
